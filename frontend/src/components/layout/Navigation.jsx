    ...
    switch (role) {
      ...
      case USER_ROLES.ADMIN:
        return [
          ...
          { to: '/admin/volunteers', icon: <VolunteerIcon isActive />, label: t('admin.volunteersTab'), iconKey: 'volunteers' },
          { to: '/admin/export', icon: <ExportIcon isActive />, label: t('admin.exportTab'), iconKey: 'export' },
        ];
      case USER_ROLES.VOLUNTEER:
        return [
          { to: '/volunteer', icon: <CheckInIcon isActive />, label: t('nav.checkIn'), iconKey: 'checkin' },
          make('/leaderboard', <LeaderboardIcon isActive />, leaderboardItem, boardTheme),
        ];
      default:
        return [];
  ...
  return (
    ...
    >
      ...
      >
        ...
        {(role === USER_ROLES.ADMIN || role === USER_ROLES.PARTICIPANT || role === USER_ROLES.JUDGE || role === USER_ROLES.VOLUNTEER) && (
          <motion.button
